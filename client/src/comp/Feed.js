 ...
 setFposts(code.response.data)
    ...
    <div id="load"></div>
      <div className="row">
           ...
           <div className="card">
             <div className="card-body" style={{border:"7px solid black",backgroundColor:"#7db6ba",borderRadius:"9px"}}>
...
<br/>
  ...
  return(
    <>     
      <div className=" my-2 col-md-6 col-xl-4 grid-margin stretch-card" >
        <div className="card" style={{border:"5px solid black", backgroundColor:"#7db6ba",borderRadius:"100px"}}>
          <div className="card-body">
          ...
          <div className="flex items-center flex-wrap ">
                    <a className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0" id={item._id} onClick={()=>props.see(item)}>See More
                      ...
                      <svg className="w-4 h-4 ml-2"  style={{width:"10px"}} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} fill="none" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <span onClick={()=>props.see(item)}className="text-gray-400 inline-flex items-center leading-none text-sm">
                      ...
                      <svg className="w-8 h-8 mr-1" stroke="currentColor" style={{width:"20px", height:"20px"}} strokeWidth={2} fill="none" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
