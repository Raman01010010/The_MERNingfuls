...
export default function SideBar(props) {
  ...
  React.useEffect(() => {
    if (Object.keys(props.Img).length === 0) navigate("/");
  }, []);
  ...
  function ch() {
    ...
    root.render(<Profile user={props.Img.email} props={props.Img} />);
  }
  function Fee() {
    const root = ReactDOM.createRoot(document.getElementById("main"));

    root.render(<Feed see={handleSeeMore} props={props.Img} />);
  }
  ...
  function handleSignUp() {
    ...
    root.render(<SignU props={props.sufun} />);
  }
  function handleSignIn() {
    const root = ReactDOM.createRoot(document.getElementById("main"));

    root.render(<SignI props={props.sifun} load={props.load} />);
  }
  function Friends() {
    const root = ReactDOM.createRoot(document.getElementById("main"));
    ...
    <div className="container-scroller">
      ...
      <nav className="sidebar sidebar-offcanvas" id="sidebar" style={{position:"fixed"}}>
        <div className="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a className="sidebar-brand brand-logo">
            <img style={{ height: "150%" }} src={""} alt="logo" />
          </a>
      ...
      <div className="container-fluid page-body-wrapper">
              ...
              <li className="nav-item dropdown">
                ...
                >
                  ...
                  <a onClick={Friends} className="dropdown-item preview-item">
                    ...
                    <div className="preview-item-content">
                      <p className="preview-subject mb-1">User</p>
                    </div>
                  </a>
                  <a
                    onClick={handleAbout}
        ...
        <div className="main-panel">
          <div className="content-wrapper"style={{marginLeft:"120px"}}>
            <div id="main">
              {" "}
